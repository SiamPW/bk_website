...
<table width="950" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td valign="top" style="padding:0px 0px 0px 12px;"><!--CNC Engraver-->
<h2>
  EZ-LETTER ROUTER</h2>
<p>
  <? if($_GET["p"]=="sk-1" || $_GET["p"]=="") { ?>
</p>
<p><span class="col_R"><img src="../images/product/cnc_b/MD103-ATC-2.jpg" alt="" /></span></p>
<p><img src="../images/product/cnc-route-1.jpg" style="width:650px" /></p>
<p>&nbsp;</p>
<h5 class="col_R"><br />
  <img src="../images/product/cnc-route-2.jpg" style="width:650px" alt="" /></h5>
<br />
<p>
  <? } ?>
  <!--end CNC Engraver-->
